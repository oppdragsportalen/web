        ...
        <Card size="3">
          ...
          <Box mb="6">
            ...
            <Text as="p" size="3" mb="3">
              Oppdragsportalen is an assignment management platform that enables
              users to create, and manage tasks and assignments. Users can
              create public assignments visible to all platform users or private
              assignments accessible only to specified individuals.
            </Text>
            <Text as="p" size="3" mb="3">
              By creating an account and using Oppdragsportalen, you accept and
          ...
          <Box mb="6">
            ...
            <Text as="p" size="3" mb="3">
              You may not share your account credentials or allow others to use
              your account. Accounts are personal and non-transferable.
            </Text>
          </Box>
          ...
          <Box mb="6">
            ...
            <Text as="p" size="3" mb="3">
              ...
              explicitly authorize. We do not claim ownership of your assignment
              content.
            </Text>
            <Text as="p" size="3" mb="3">
              You are solely responsible for the content of your assignments and
              must ensure you have the right to share any information included.
            </Text>
          </Box>
          ...
          <Box mb="6">
            ...
            <Text as="p" size="3" mb="3">
              Our total liability for any claim related to the platform shall be
              zero, and you shall not be entitled to receive any damages,
