...
export default function PrivacyPolicyPage() {
  return (
    <Flex justify="center" py="9" px="4" minWidth="400px">
        ...
        <Card size="3">
          ...
          <Box mb="6">
            ...
            <Text as="p" size="3" mb="3">
              Oppdragsportalen is an assignment management platform that allows
              users to create, and manage tasks and assignments. This Privacy
          ...
          <Box mb="6">
            ...
            <Text as="p" size="3" mb="3">
              ...
              we collect your name, email address, and password encrypted.
            </Text>
            <Text as="p" size="3" mb="3">
              <strong>Assignment Data:</strong> We store assignments you create,
              including titles, descriptions, deadlines, and visibility settings
              (public or private). For private assignments, we also store the
              email addresses of users you grant access to.
            </Text>
            <Text as="p" size="3" mb="3">
              <strong>Assignment Claims:</strong> We track which assignments you
              accept, decline, or mark as in-progress or finished.
            </Text>
            <Text as="p" size="3" mb="3">
              <strong>Usage Data:</strong> We collect information about how you
              interact with the platform, including login times and assignment
              activity.
            </Text>
          </Box>
          ...
          <Box mb="6">
            ...
            <Text as="p" size="3" mb="3">
              <strong>Private Assignments:</strong> Private assignments are only
              visible to you and users you explicitly grant access to via their
              email addresses.
            </Text>
            <Text as="p" size="3" mb="3">
              <strong>Third-Party Services:</strong> We use Supabase, a secure
              database and authentication platform, to store and manage all user
              data. Supabase processes data on our behalf under strict
          ...
          <Box mb="6">
            ...
            <Box ml="4" mb="3">
              <Text as="div" size="3" mb="2">
                • <strong>Authentication:</strong> Powered by Supabase Auth with
                secure password hashing (bcrypt)
              </Text>
              <Text as="div" size="3" mb="2">
                • <strong>Encryption at Rest:</strong> All data is encrypted in
                the Supabase database using AES-256 encryption
              </Text>
              <Text as="div" size="3" mb="2">
              ...
              <Text as="div" size="3" mb="2">
                • <strong>Infrastructure:</strong> Hosted on secure, SOC 2 Type
                II compliant infrastructure
              </Text>
            </Box>
            <Text as="p" size="3" mb="3">
            ...
            <Text as="p" size="3" mb="3">
              ...
              secure. While we strive to protect your data using best practices,
          ...
          <Box mb="6">
            ...
            <Text as="p" size="3" mb="3">
              ...
              permanently removed from our database. If you delete your account,
